...
<html lang="en">
    ...
    <head>
        ...
        <!-- page css -->
        <link href="<?php echo base_url(); ?>main_assets/admin_asset/assets/dist/css/pages/error-pages.css" rel="stylesheet">
        ...
        <section id="wrapper" class="error-page">
            <div class="error-box">
                <div class="error-body text-center">
                    <h1>404</h1>
                    <h3 class="text-uppercase">Page Tidak Ditemukan !</h3>
                    <p class="text-muted m-t-30 m-b-30">MAAF PAGE YANG ANDA CARI TIDAK DITEMUKAN, SILAHKAN KEMBALI KE DASHBOARD</p>
                    <a onclick="history.back()" class="btn btn-info btn-rounded waves-effect waves-light m-b-40 text-white"><- Kembali ke Dashboad</a> </div>
            </div>
        </section>
        <!-- ============================================================== -->
        <!-- End Wrapper -->
